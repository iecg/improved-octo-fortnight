 ...
 * One plan, in full.
 *
 * Reached from a row on the plans screen and deep-linkable by id. Read by id
 * through the domain repository, so an id from the intimacy app's domain
 * resolves to nothing rather than crossing the boundary.
 */
      ...
      {plan ? (
        <>
          {/* The couple's own words when they gave any, shown verbatim;
              otherwise the commitment's name. */}
